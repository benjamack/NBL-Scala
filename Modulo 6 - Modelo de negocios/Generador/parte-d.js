...
module.exports = [
  ...
  p('Para elaborar este trabajo se hizo uso de Claude, de Anthropic, como espacio de trabajo compartido donde se centralizó el contexto del proyecto: los documentos de los módulos anteriores, el modelo de unit economics del Documento 3 y los resultados del experimento del Módulo 5.'),

  T('Motivación'),
  p('El propósito principal fue sostener la coherencia entre los nueve bloques del canvas y la trazabilidad de cada número del entregable. El margen bruto y el punto de equilibrio se recalcularon a partir de los supuestos del Documento 3, y cada cifra de evidencia se contrastó con los registros del Módulo 5, para que ningún número quedara separado de su fuente.'),

  T('Uso reflexivo y enfoque dialógico'),
  p('La interacción con la inteligencia artificial fue la de un copiloto de pensamiento y no la de un generador pasivo de texto. Claude se usó para ordenar las consignas del módulo, revisar la coherencia del canvas bloque por bloque, buscar en la web y contrastar evidencia externa, y producir primeros borradores, que luego fueron revisados, corregidos y reescritos. Las decisiones sobre el modelo de negocios, la interpretación de la evidencia y la redacción final son nuestra responsabilidad.'),
